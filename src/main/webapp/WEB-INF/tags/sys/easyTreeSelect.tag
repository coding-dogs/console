...
<script type="text/javascript">
	$("#${id}Button, #${id}Name").click(function(){
		...
		top.layer.open({
		    ...
		    area: ['300px', '420px'],
		    title:"选择${title}",
		    content: "${ctx}/tag/treeselect?url="+encodeURIComponent("${url}")+"&module=${module}&checked=${checked}&extId=${extId}&isAll=${isAll}&selectIds="+selectIds+"&maxLevel=${allowMaxLevel}" ,
		    btn: ['确定', '关闭']
